                        ...
                        <div class="products-tabs">
                            ...
                            <div id="tab1" class="tab-pane active">
                                <div class="products-slick" data-nav="#slick-nav-1">
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{asset('client/img/product03.png')}}" alt="">
                                            <div class="product-label">
                                                <span class="sale">-30%</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{asset('client/img/product04.png')}}" alt="">
                                        </div>
                                        <div class="product-body">
                                            <p class="product-category">Category</p>
                                            <h3 class="product-name"><a href="#">product name goes here</a></h3>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{asset('client/img/product05.png')}}" alt="">
                                        </div>
                                        <div class="product-body">
                                            <p class="product-category">Category</p>
                                            <h3 class="product-name"><a href="#">product name goes here</a></h3>
                        ...
                        <div class="products-tabs">
                            ...
                            <div id="tab2" class="tab-pane fade in active">
                                <div class="products-slick" data-nav="#slick-nav-2">
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{asset('client/img/product06.png')}}" alt="">
                                            <div class="product-label">
                                                <span class="sale">-30%</span>
                                                <span class="new">NEW</span>
                                            </div>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{asset('client/img/product07.png')}}" alt="">
                                            <div class="product-label">
                                                <span class="new">NEW</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{asset('client/img/product09.png')}}" alt="">
                                        </div>
                                        <div class="product-body">
                                            <p class="product-category">Category</p>
                                            <h3 class="product-name"><a href="#">product name goes here</a></h3>
