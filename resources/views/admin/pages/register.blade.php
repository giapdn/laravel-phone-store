...
<script src="{{asset('admin_resources/libs/jquery/dist/jquery.min.js')}}"></script>
<script src="{{asset("admin_resources/libs/bootstrap/dist/js/bootstrap.bundle.min.js")}}"></script>
</body>
